...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/js/main.js":[function(require,module,exports) {
"use strict";
...
var search = function search(city) {
  var apiUrl = "".concat(_constants.BASE_URL, "/weather?q=").concat(city, "&appid=").concat(_constants.KEY, "&units=").concat(units);
...
var showCityWheather = function showCityWheather(response) {
  var _response$data = response.data,
      cityName = _response$data.name,
      _response$data$weathe = _slicedToArray(_response$data.weather, 1),
      _response$data$weathe2 = _response$data$weathe[0],
      weatherTitle = _response$data$weathe2.main,
      weatherDescription = _response$data$weathe2.description,
      iconId = _response$data$weathe2.icon,
      _response$data$main = _response$data.main,
...
fahrenheit.addEventListener("click", function (event) {
  event.preventDefault();
  var fahrenheitTemp = Math.round(convertedTemperature * 9 / 5 + 32);
...
search("Miami");
},{"./constants":"src/js/constants.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
