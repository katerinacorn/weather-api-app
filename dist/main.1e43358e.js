...
var units = "metric"; //todo: refact format
...
var setCoordinates = function setCoordinates(position) {
  latitude = position.coords.latitude;
  longitude = position.coords.longitude;
  console.log(position);
};

var currentPosition = navigator.geolocation.getCurrentPosition(setCoordinates);

var getWeatherData = function getWeatherData() {
  var URL = "".concat(BASE_URL, "/weather?lat=").concat(latitude, "&lon=").concat(longitude, "&appid=").concat(KEY, "&units=").concat(units);
  axios.get(URL).then(showCityWheather);
};

document.getElementById("app").innerHTML = "\n<div class=\"card\">\n        <header class=\"card__header\">\n          <span class=\"card__header-emoji\">\uD83D\uDCCC</span>\n          <h1 class=\"card__header-location\">\n          </h1>\n          <form id=\"search-form\" class=\"card__header-search\">\n            <input\n              class=\"form-control\"\n              type=\"search\"\n              name=\"search\"\n              id=\"search\"\n              placeholder=\"Type a city...\"\n            />\n            <input id=\"search-btn\" class=\"btn btn-primary\" type=\"submit\" value=\"Search\" />\n            <button id=\"localisation-btn\" type=\"button\" class=\"btn btn-outline-danger\">Current</button>\n          </form>\n        </header>\n        <section class=\"card__content\">\n          <div class=\"card__content-current\">\n            <h3 class=\"heading current\">\n                ".concat(day, ", ").concat(currentTime, "\n            </h3>\n            <img id=\"icon\" class=\"emoji\"/>\n            <p class=\"status\"></p>\n            <div class=\"temperature\">\n              <strong id=\"temperature\"></strong>\n              <a id=\"celsius\" class=\"temperature__link celsius active\" href=\"#\">\u2103</a>\n              <a id=\"fahrenheit\" class=\"temperature__link fahrenheit\" href=\"#\">\u2109</a>\n            </div>\n            <div class=\"weather-details\">\n              <p class=\"weather__description\"></p>\n              <p class=\"weather__wind\"></p>\n              <span id=\"humidity\"></span>\n            \n            </div>\n          </div>\n          <div class=\"card__content-forecast\">\n            <div class=\"line\">\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  mon\n                </h4>\n                <span class=\"emoji\">\n                  \u2600\uFE0F\n                </span>\n                <p class=\"status\">sunny</p>\n                <strong>23\xBA</strong>\n              </div>\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  tue\n                </h4>\n                <span class=\"emoji\">\n                  \u2600\uFE0F\n                </span>\n                <p class=\"status\">sunny</p>\n                <strong>25\xBA</strong>\n              </div>\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  wed\n                </h4>\n                <span class=\"emoji\">\n                  \u2601\uFE0F\n                </span>\n                <p class=\"status\">cloudy</p>\n                <strong>15\xBA</strong>\n              </div>\n            </div>\n            <div class=\"line\">\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  thu\n                </h4>\n                <span class=\"emoji\">\n                  \u26C8\uFE0F\n                </span>\n                <p class=\"status\">rainy</p>\n                <strong>12\xBA</strong>\n              </div>\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  fri\n                </h4>\n                <span class=\"emoji\">\n                  \u26C8\uFE0F\n                </span>\n                <p class=\"status\">rainy</p>\n                <strong>5\xBA</strong>\n              </div>\n              <div class=\"day\">\n                <h4 class=\"heading\">\n                  sat\n                </h4>\n                <span class=\"emoji\">\n                  \u26C8\uFE0F\n                </span>\n                <p class=\"status\">rainy</p>\n                <strong>10\xBA</strong>\n              </div>\n            </div>\n          </div>\n        </section>\n      </div>\n"); //TODO display weather + refact
...
var weatherDescriptionElement = document.querySelector(".weather__description");
...
var showCityWheather = function showCityWheather(response) {
  ...
  var weatherIconId = response.data.weather[0].icon;
  var weatherStatus = response.data.weather[0].main;
  var humidity = "humidity: ".concat(response.data.main.humidity, " %");
  iconElement.setAttribute("src", "http://openweathermap.org/img/wn/".concat(weatherIconId, "@2x.png"));
  iconElement.setAttribute("alt", weatherDescription);
  humidityElement.innerHTML = humidity;
  weatherStatusElement.innerHTML = weatherStatus;
  weatherDescriptionElement.innerHTML = weatherDescription;
  weatherWindElement.innerHTML = "".concat(windSpeed, " meter/sec");
  temperature.innerHTML = temp;
  header.innerHTML = "".concat(cityName);
...
celsius.addEventListener("click", function () {
  var celsTemp = Math.round(temp);
  temperature.innerHTML = celsTemp;
  celsius.classList.add("active");
  fahrenheit.classList.remove("active");
});
fahrenheit.addEventListener("click", function () {
  var fahrTemp = Math.round(temp * 9 / 5 + 32);
...
var search = function search(city) {
  var apiUrl = "".concat(BASE_URL, "/weather?q=").concat(city, "&appid=").concat(KEY, "&units=").concat(units);
